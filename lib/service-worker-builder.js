...
const Typescript = require('broccoli-typescript-transpiler');
...
module.exports = class ServiceWorkerBuilder {
  constructor(options) {
    ...
    this.babelOverrides = options.babelOverrides;
  ...
  _compileTrees(trees, treeName) {
    ...
    tree = this._typescriptCompile(tree);
